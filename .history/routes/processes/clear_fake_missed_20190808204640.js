...
async function clearFakeAppointment(message, user) {
    ...
    if (
                ...
                .then(async([old_app, updated]) => {
                    if (updated) {
                        ...
                        let create_appointment = await Appointment.create({
                            ...
                            return {
                                code: 200,
                                message: `Appointment for ${Client.clinic_number} on ${app_date} was created successfully`
                            };
                        });
        ...
        return {
            code: 400,
            message: "The selected appointment is not marked as missed or defaulted in the system"
        };
    }
}
